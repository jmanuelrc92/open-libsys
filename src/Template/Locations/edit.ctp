...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('List Book Inventories'), ['controller' => 'BookInventories', 'action' => 'index']) ?></li>
        <li><?= $this->Html->link(__('New Book Inventory'), ['controller' => 'BookInventories', 'action' => 'add']) ?></li>
    </ul>
</nav>
