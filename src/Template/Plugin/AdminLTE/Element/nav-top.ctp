<nav class="navbar navbar-static-top">
	...
	<div class="navbar-custom-menu">
		<ul class="nav navbar-nav">
          ...
          <span class="hidden-xs"><?= h($personName)?></span>
			</a>
				<ul class="dropdown-menu">
					<!-- User image -->
            ...
            <p>
              <?= h($personName)?>
              <small>Member since <?= h($registrationDate)?></small>
						</p>
					</li>
					<!-- Menu Body -->
					<li class="user-body">
					...
					<li class="user-footer">
						...
						<div class="pull-right">
							<?= $this->Html->link('Sign out', ['controller' => 'users', 'action' => 'logout'], ['class' => 'btn btn-default btn-flat'])?>
						</div>
					</li>
				</ul></li>
